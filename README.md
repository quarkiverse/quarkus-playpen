...
```shell
kubectl apply -f https://raw.githubusercontent.com/quarkiverse/quarkus-playpen/0.9/operator/playpenconfigs-crd.yml
kubectl apply -f https://raw.githubusercontent.com/quarkiverse/quarkus-playpen/0.9/operator/playpens-crd.yml
kubectl apply -f https://raw.githubusercontent.com/quarkiverse/quarkus-playpen/0.9/operator/operator.yml
```
...
`http://192.168.49.2:320.9/local/john?hijack=true`
...
```shell
playpen local connect --credentials=mysecret --local-port=8080 http://192.168.49.2:320.9/local/john?hijack=true
```
