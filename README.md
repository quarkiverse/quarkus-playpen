...
`http://192.168.49.2:320.9.6/local/john?hijack=true`
...
```shell
playpen local connect --credentials=mysecret --local-port=8080 http://192.168.49.2:320.9.6/local/john?hijack=true
```
